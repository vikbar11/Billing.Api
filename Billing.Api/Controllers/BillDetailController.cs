...
namespace Billing.Api.Controllers
{
    ...
    public class BillDetailController : ControllerBase
    {
        ...
        public async Task<ActionResult<BillDetail>> PostBillDetail(BillDetailDTO billDetailDTO)
        {
            ...
            billDetail.IdBillDetail = billDetailDTO.IdBillDetailDTO;
            billDetail.IdBill = billDetailDTO.IdBillDTO;
            billDetail.Description = billDetail.Description;
            billDetail.IdProduct = billDetailDTO.IdProductDTO;
            billDetail.Quantity = billDetailDTO.QuantityDTO;
